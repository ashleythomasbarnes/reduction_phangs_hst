...
run_contsub_nomuse = True # This includes cosmic steps too..
run_cosmics = False
...
output_dir = './%s_%s_%s/' % (halpha_filter, cont1_filter, cont2_filter)  # Define the output directory path
