...
def get_mask(halpha_filename):
    ...
    fits.PrimaryHDU(np.int32(mask_close*1), hdu.header).writeto(halpha_filename.replace('raw.fits', 'mask.fits'), overwrite=True)
    
    print('[INFO] Saving mask: %s' %halpha_filename.replace('raw.fits', 'mask.fits'))
